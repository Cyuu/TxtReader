...
public class BookPageFactory {
    ...
    private int marginWidth = 15; // 左右与边缘的距离  15
    private int marginHeight = 20; // 上下与边缘的距离 20
    ...
    public BookPageFactory(int w, int h) {
        ...
        m_fontSize = VUtils.dp2px(m_fontSize); // todo dp转px
